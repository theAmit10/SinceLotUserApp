    ...
    const selectDoc = async () => {
      try {
        ...
        if (doc) {
          ...
          console.log('Image type ty:: ' + ty);
          console.log('Image type getFileExtension(mimeType):: ' + getFileExtension(doc[0].type));
...
//     {
//       name: 'Aman',
//       upiid: '8876543210@ybl',
//       id: '2',
//     },

//     {
//       name: 'Zasu',
//       upiid: '7876543210@ybl',
//       id: '3',
//     },
//     {
//       name: 'Masu',
//       upiid: '1876543210@ybl',
//       id: '4',
//     },
//     {
//       name: 'Kasu',
//       upiid: '2876543210@ybl',
//       id: '5',
//     },
//   ];
...
//   const settingUpiOptionView = () => {
//     upiVisible === true ? setUpiVisible(false) : setUpiVisible(true);
//   };
...
//               {/** UPI  */}
//               <TouchableOpacity onPress={settingUpiOptionView}>
//                 <LinearGradient
//                   colors={[COLORS.time_firstblue, COLORS.time_secondbluw]}
//                   style={{
//                     flexDirection: 'row',
...
//                         <TouchableOpacity onPress={() => copyToClipboard(item.upiid)}>
//                           <LinearGradient
//                             colors={[COLORS.lightWhite, COLORS.white_s]}
//                             className="rounded-xl p-1">
//                             <AntDesign
