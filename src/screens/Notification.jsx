...
//   lotTime.setHours(8); // Set lot time hours (example: 8 AM)
...
//         <Text style={styles.timeText}>Lot Time: {lotTime.toLocaleTimeString()}</Text>
//       </View>
//       <View>
//       <Countdown
//         until={timeDifference / 1000} // Pass time difference in seconds
//         onFinish={() => alert('Countdown finished')} // Callback when countdown finishes
//         size={15}
//         timeToShow={['H', 'M', 'S']}
